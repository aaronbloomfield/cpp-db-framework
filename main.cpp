...
int main(int argc, char** argv) {
    ...
    cout << "Writing myassert.h/cpp..." << endl;
    ofstream myassert("dbcpp/myassert.h");
    myassert << "// This file generated by the C++ DB framework: https://github.com/aaronbloomfield/cpp-db-framework\n\n";
    myassert << "#ifndef MYASSERT_H\n#define MYASSERT_H\n\n#include <assert.h>\n\n#define myassert(x) assert(x)\n\n#endif\n";
    myassert.close();
    system ("touch dbcpp/myassert.cpp");
    ofilelist += " myassert.o";
